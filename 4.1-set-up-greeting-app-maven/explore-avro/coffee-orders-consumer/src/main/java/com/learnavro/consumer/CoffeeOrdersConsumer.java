...
//        Runtime.getRuntime().addShutdownHook(shutdownHook);
        ...
        while(true) {
            ...
            for(ConsumerRecord<String, byte[]> record : records) {
                ...
                // ZoneId.SHORT_IDS
                LocalDateTime pltDateTime = LocalDateTime.ofInstant(coffeeOrder.getOrderedTime(), ZoneId.of("Asia/Karachi"));
                ...
                LOG.info("pltDateTime: {}, cstDateTime: {}", pltDateTime, cstDateTime);
