...
public class CoffeeOrderProducer {
    ...
    public void sendMessage(CoffeeOrder coffeeOrderAvro) {
        ...
        ListenableFuture<SendResult<String,CoffeeOrder>> listenableFuture =  kafkaTemplate.send(producerRecord);// send return type is ListenableFuture<SendResult<K, V>>, K<V in SendResult is same as the value in KafkaTemplate<K,V>
